...
$(document).ready(function(){
	...
	var link1=new Link({id:2,name:'media',icon:'images\\icon\\2.png',left:20,top:110,url:'plugin/media.html'});
	...
	var link6=new Link({id:7,name:'文件管理',icon:'images\\149\\BlankOn_Icons_013.png',left:150,top:20,url:'plugin/showFile.php'});
	...
	ptui.desktop.addLinks(new Array(link,link1,link2,link3,link4,link5,link6));
});
